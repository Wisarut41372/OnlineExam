        ...
        <div class="app-main__inner">
                     ...
                     <div class="page-title-heading">
                        <div> จัดการข้อสอบ
                            <div class="page-title-subheading">
                              เพิ่มคำถาม  <?php echo $selExamRow['ex_title']; ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                  <div class="col-md-6">
                      <div class="main-card mb-3 card">
                          <div class="card-header">
                            <i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>รายละเอียดของข้อสอบ
                          </div>
                          <div class="card-body">
                           <form method="post" id="updateExamFrm">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" name="examLimit" required="">
                                  <option value="<?php echo $selExamRow['ex_time_limit']; ?>"><?php echo $selExamRow['ex_time_limit']; ?> นาที</option>
                              ...
                              <div class="form-group" align="right">
                                <button type="submit" class="btn btn-primary btn-lg">อัพเดท</button>
                              </div> 
                           </form>                           
                          </div>
                      </div>
                  ...
                  <div class="col-md-6">
                    ...
                    ?>
                     <div class="main-card mb-3 card">
                          <div class="card-header"><i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>คำถาม 
                            <span class="badge badge-pill badge-primary ml-2">
                              <?php echo $selQuest->rowCount(); ?>
                            </span>
                             <div class="btn-actions-pane-right">
                                <button class="btn btn-sm btn-primary " data-toggle="modal" data-target="#modalForAddQuestion">เพิ่มคำถาม</button>
                              </div>
                          </div>
                          <div class="card-body" >
                            ...
                            <?php 
                               ...
                               {  ?>
                                 <div class="table-responsive">
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                                        <thead>
                                        <tr>
                                            <th class="text-left pl-1">คำถาม / ตอบ</th>
                                               ...
                                               while ($selQuestionRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <tr>
                                                        ...
                                                        <td class="text-center">
                                                         <a rel="facebox" href="facebox_modal/updateQuestion.php?id=<?php echo $selQuestionRow['eqt_id']; ?>" class="btn btn-sm btn-primary ">แก้ไข</a>
                                                         <button type="button" id="deleteQuestion" data-id='<?php echo $selQuestionRow['eqt_id']; ?>'  class="btn btn-danger btn-sm">ลบ</button>
                                                        </td>
                                                    </tr>
                                               <?php }
                                            }
                               ...
                               { ?>
                                  <h4 class="text-primary">ไม่พบคำถาม ...</h4>
                                 <?php
                               }
                             ?>
                               </div>
