<div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <?php 
                   ...
                   <div class="app-page-title">
                    <div class="page-title-wrapper">
                        ...
                        <div><b class="text-primary">RANKING BY EXAM</b><br>
                                ข้อสอบ : <?php echo $selEx['ex_title']; ?><br><br>
                               <span class="border" style="padding:10px;color:black;background-color: yellow;">สุดยอด</span>
                               <span class="border" style="padding:10px;color:white;background-color: green;">ดี</span>
                               <span class="border" style="padding:10px;color:white;background-color: blue;">ปานกลาง</span>
                               <span class="border" style="padding:10px;color:white;background-color: red;">แย่</span>
                               <span class="border" style="padding:10px;color:black;background-color: #E9ECEE;">ยังไม่ได้ทำ</span>
                            </div>
                        </div>
                    </div>
                    </div>
                ...
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        <div><b>จัดอันดับคะแนนของข้อสอบ</b></div>
                    </div>
                </div>
                </div> 
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header">รายชื่อข้อสอบ
                    </div>
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                            <tr>
                                <th class="text-left pl-4">ข้อสอบ</th>
                                    ...
                                    while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                             <a href="?page=ranking-exam&exam_id=<?php echo $selExamRow['ex_id']; ?>"  class="btn btn-success btn-sm">เช็ค</a>
                                            </td>
                                        </tr>
